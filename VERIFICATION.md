# Verification plan — Farming Simulator 25

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Field cost worksheets

- [ ] Define a versioned input fixture specifically for field cost worksheets.
...
### 2. Machine lease comparisons

- [ ] Define a versioned input fixture specifically for machine lease comparisons.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Farm profile checkpoints

- [ ] Define a versioned input fixture specifically for farm profile checkpoints.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
