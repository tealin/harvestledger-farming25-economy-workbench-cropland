...
独立的项目设计文档，适用对象： **Farming Simulator 25**。
...
- **田地成本工作表** (Field cost worksheets) — 规划模块，尚未实现。
- **机械租赁比较** (Machine lease comparisons) — 规划模块，尚未实现。
- **农场配置检查点** (Farm profile checkpoints) — 规划模块，尚未实现。
