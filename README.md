...
<div align="center">
  <img src="./public/logo.svg" alt="HarvestLedger — Farming Simulator 25 — Cropland" width="64" height="64">
  <h1>HarvestLedger — Farming Simulator 25 — Cropland</h1>
</div>

An independent project specification for Farming Simulator 25, covering field cost worksheets, machine lease comparisons, farm profile checkpoints.
...
<img src="./public/screenshots/desktop-main.svg" alt="Farming Simulator 25 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Farming Simulator 25 — compact concept, not a screenshot" width="250">
<br>
...
- **Field cost worksheets** — planned module; not implemented.
- **Machine lease comparisons** — planned module; not implemented.
- **Farm profile checkpoints** — planned module; not implemented.

The proposed workflow separates field cost worksheets from machine lease comparisons, with farm profile checkpoints retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Field cost worksheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="HarvestLedger — Farming Simulator 25 — Cropland — specification review workflow">
<br>
...
### Field cost worksheets

Define the input and expected outcome for module 1. Record the Farming Simulator 25 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Machine lease comparisons

Define the input and expected outcome for module 2. Record the Farming Simulator 25 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Farm profile checkpoints

Define the input and expected outcome for module 3. Record the Farming Simulator 25 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Farming Simulator 25 |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Field cost worksheets |
